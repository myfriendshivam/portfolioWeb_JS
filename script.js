...
darkStyle.innerHTML = `
.dark-mode {
    background: linear-gradient(0.25turn, #1a1a1a);
    color: #f5f5f5;
}
.dark-mode table {
...
// Typing Animation for Title (Looping)
...
const showModal = (text) => {
    ...
    modalContent.innerHTML = `<p>${text}</p><button style="margin-top:10px; padding:4px;">Close</button>`;
...
footer.innerHTML = `© ${new Date().getFullYear()} All rights reserved by Shivam Kant`;
